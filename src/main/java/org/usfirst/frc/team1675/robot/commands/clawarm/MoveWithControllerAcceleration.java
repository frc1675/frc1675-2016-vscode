 ...
 *
 */
public class MoveWithControllerAcceleration extends Command {

    public MoveWithControllerAcceleration() {
    ...
    protected void execute() {
    	...
    	Robot.clawArm.moveWithoutEncoderWithAcceleration(motorPower);
    }
